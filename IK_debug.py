...
def test_code(test_case):
	...
	#T0_2 = simplify(T0_1 * T1_2) # bask_link to link2
	#T0_3 = simplify(T0_2 * T2_3) # bask_link to link3
	#T0_4 = simplify(T0_3 * T3_4) # bask_link to link4
	#T0_5 = simplify(T0_4 * T4_5) # bask_link to link5
	#T0_6 = simplify(T0_5 * T5_6) # bask_link to link6
	#T0_G = simplify(T0_6 * T6_G) # bask_link to gripper_link
    ...
    # theta3 = angle_b-atan2((0.96+0.54)/0.054)
